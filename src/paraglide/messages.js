 ...
 * @returns {string}
 */
export const drop_zone = (params = {}, options = {}) => {

	const tag = options.languageTag ?? languageTag();
	if (tag === "en") return en.drop_zone()
 ...
 * @returns {string}
 */
export const try_it_images = (params = {}, options = {}) => {

	const tag = options.languageTag ?? languageTag();
	if (tag === "en") return en.try_it_images()
	// if the language tag does not exist, return undefined
	// 
	// the missing translation lint rule catches errors like this in CI/CD
	// see https://inlang.com/m/4cxm3eqi/messageLintRule-inlang-missingTranslation
 ...
 * @returns {string}
 */
export const feedback = (params = {}, options = {}) => {

	const tag = options.languageTag ?? languageTag();
	if (tag === "en") return en.feedback()
	// if the language tag does not exist, return undefined
	// 
	// the missing translation lint rule catches errors like this in CI/CD
	// see https://inlang.com/m/4cxm3eqi/messageLintRule-inlang-missingTranslation
 ...
 * @returns {string}
 */
export const start_new = (params = {}, options = {}) => {

	const tag = options.languageTag ?? languageTag();
	if (tag === "en") return en.start_new()
	// if the language tag does not exist, return undefined
	// 
	// the missing translation lint rule catches errors like this in CI/CD
	// see https://inlang.com/m/4cxm3eqi/messageLintRule-inlang-missingTranslation
 ...
 * @returns {string}
 */
export const bruch_size = (params = {}, options = {}) => {

	const tag = options.languageTag ?? languageTag();
	if (tag === "en") return en.bruch_size()
	// if the language tag does not exist, return undefined
	// 
	// the missing translation lint rule catches errors like this in CI/CD
	// see https://inlang.com/m/4cxm3eqi/messageLintRule-inlang-missingTranslation
 ...
 * @returns {string}
 */
export const original = (params = {}, options = {}) => {

	const tag = options.languageTag ?? languageTag();
	if (tag === "en") return en.original()
	// if the language tag does not exist, return undefined
	// 
	// the missing translation lint rule catches errors like this in CI/CD
	// see https://inlang.com/m/4cxm3eqi/messageLintRule-inlang-missingTranslation
 ...
 * @returns {string}
 */
export const upscale = (params = {}, options = {}) => {

	const tag = options.languageTag ?? languageTag();
	if (tag === "en") return en.upscale()
	// if the language tag does not exist, return undefined
	// 
	// the missing translation lint rule catches errors like this in CI/CD
	// see https://inlang.com/m/4cxm3eqi/messageLintRule-inlang-missingTranslation
 ...
 * @returns {string}
 */
export const inpaint_model_download_message = (params = {}, options = {}) => {

	const tag = options.languageTag ?? languageTag();
	if (tag === "en") return en.inpaint_model_download_message()
	// if the language tag does not exist, return undefined
	// 
	// the missing translation lint rule catches errors like this in CI/CD
	// see https://inlang.com/m/4cxm3eqi/messageLintRule-inlang-missingTranslation
 ...
 * @returns {string}
 */
export const upscaleing_model_download_message = (params = {}, options = {}) => {

	const tag = options.languageTag ?? languageTag();
	if (tag === "en") return en.upscaleing_model_download_message()
	// if the language tag does not exist, return undefined
	// 
	// the missing translation lint rule catches errors like this in CI/CD
	// see https://inlang.com/m/4cxm3eqi/messageLintRule-inlang-missingTranslation
